...
namespace OracleDatabaseAccess
{
    class Program
    {
        ...
        {
            //string conString = "User Id=system;Password=Pa$$w0rd;Data Source=scott";
            string conString = "User Id=SYSTEM;Password=password;Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=localhost)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=scott)))";
